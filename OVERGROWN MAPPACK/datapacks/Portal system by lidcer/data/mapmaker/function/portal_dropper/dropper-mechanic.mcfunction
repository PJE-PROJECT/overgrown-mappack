...
#execute if entity @e[type=minecraft:armor_stand,tag=2pcd,tag=2pcd_rusted,tag=!useless,scores={animationtime=1449}] run item replace entity @e[type=minecraft:armor_stand,tag=2pcd,tag=2pcd_rusted,tag=!useless,scores={animationtime=1449}] armor.head with minecraft:netherite_shovel[minecraft:custom_model_data=95]
